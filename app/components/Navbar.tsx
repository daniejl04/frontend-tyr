    ...
    <nav className="fixed top-0 w-full z-50 bg-surface/80 backdrop-blur-md border-b border-outline-variant/20">
      <div className="flex justify-between items-center px-8 h-20 w-full max-w-full">
        ...
        <div className="hidden md:flex items-center space-x-8 font-bold tracking-tight">
          ...
          <a className="text-secondary hover:text-on-surface transition-colors" href="/catalog">{dict.spareParts}</a>
          <a className="text-secondary hover:text-on-surface transition-colors" href="/services">{dict.services}</a>
          <a className="text-secondary hover:text-on-surface transition-colors" href="/about">{dict.about}</a>
        </div>
