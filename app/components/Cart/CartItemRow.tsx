  ...
  return (
    <div className="bg-white p-8 flex gap-8 border border-outline-variant/10 group relative">
      <div className="w-40 h-40 bg-surface-container-low flex items-center justify-center overflow-hidden flex-shrink-0">
        <img src={item.image} alt={item.name} className="w-4/5 object-contain grayscale group-hover:grayscale-0 transition-all duration-500" />
      </div>
      ...
      <div className="flex-1 space-y-4">
        <div className="flex justify-between items-start">
          ...
          <button className="text-tertiary hover:text-error transition-colors p-2">
        ...
        <div className="flex justify-between items-end pt-4">
          <div className="flex border border-outline-variant/30">
            <button className="px-3 py-1 hover:bg-surface-variant transition-colors border-r border-outline-variant/30 font-black">-</button>
            <span className="px-5 py-1 font-black text-sm">{item.quantity}</span>
            <button className="px-3 py-1 hover:bg-surface-variant transition-colors border-l border-outline-variant/30 font-black">+</button>
          </div>
